...
#fitting Random Forest classifier into training set
from sklearn.ensemble import RandomForestClassifier
classifier = RandomForestClassifier(n_estimators = 10, criterion = 'gini', random_state = 100)
...
plt.xlabel('result')
plt.title('Random Forest Predicted vs. Actual class label')
